export declare const sendVerificationEmail: (name: string, email: string, verificationToken: string) => Promise<void>;
export declare const sendWelcomeEmail: (email: string, name: string) => Promise<void>;
export declare const sendPasswordResetEmail: (email: string, otp: string) => Promise<void>;
